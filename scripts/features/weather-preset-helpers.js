...
export function createWeatherPresetHelpers({
  ...
  const WEATHER_PRESET_DEFINITIONS = Object.freeze([
    ...
    { id: "cloudy", label: "Cloudy", visibilityModifier: -1, darkness: 0.3, note: "Low cloud cover and muted light." },
    {
      ...
      darkness: 0.4,
      note: "Rain interferes with spotting and footing."
    },
    {
      id: "stormy",
      label: "Stormy",
      ...
      darkness: 0.65,
      note: "Thunderstorm conditions reduce awareness."
    },
    {
      id: "snowy",
      label: "Snowy",
      ...
      darkness: 0.45,
      note: "Snowfall obscures distance and tracks."
    },
    {
      id: "hail",
      label: "Hail",
      visibilityModifier: -2,
      darkness: 0.5,
      note: "Hail disrupts movement and ranged visibility."
    }
  ]);
  ...
  function normalizeWeatherDaeChange(entry = {}) {
    ...
    const validModes = new Set(Object.values(constRef.ACTIVE_EFFECT_MODES ?? {}).map((v) => Number(v)));
    return {
  ...
  function describeWeatherDaeChanges(_changes = []) {
    return "No additional global DAE changes.";
  }
