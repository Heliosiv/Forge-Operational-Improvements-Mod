...
assert.equal(APP_WINDOW_PROFILE_BY_ID["party-operations-command-center"], "command-center");
...
assert.equal(APP_WINDOW_POSITION_STORAGE_KEYS["command-center"], "main-ops");
...
assert.equal(APP_WINDOW_SIZE_PROFILES["command-center"], APP_WINDOW_SIZE_PROFILES["operations-shell"]);
