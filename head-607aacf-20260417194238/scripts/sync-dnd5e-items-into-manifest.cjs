...
function printUsage() {
  const usage = [
    "Usage: node scripts/sync-dnd5e-items-into-manifest.cjs [options]",
    "",
    "Options:",
    "  --source <path>          Source dnd5e LevelDB pack path.",
    "  --manifest <path>        Target manifest .db path.",
    "  --report <path>          Output report JSON path.",
    "  --collection <name>      Source compendium collection id.",
    "  --allowed-types <list>   Comma-separated item types for balanced mode.",
    "  --balanced               Enable balanced mode filters and tuning.",
    "  --derive-spell-pricing   Derive spell pricing in balanced mode.",
    "  --write                  Persist merged manifest output.",
    "  --no-backup              Skip creating pre-sync backup file.",
